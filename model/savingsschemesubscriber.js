...
const savingsSchemeSubscriberSchema = new mongoose.Schema({
  ...
  scheme: { type: mongoose.Schema.Types.ObjectId, ref: "Scheme" }, // Reference to Scheme
  aadharNo: {
    type: String,
    validate: {
  ...
  schemeName: { type: String }, // Ensure this field exists
  subscribedDate: {type: Date},          // New field
  nextDueDate: {type: Date},              // New field
