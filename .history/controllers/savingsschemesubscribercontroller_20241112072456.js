  ...
  try {
    ...
    res.status(200).json({
      ...
      schemeDetails: {
        ...
        nextDueDate: subscriber.scheme.duedate, // Use 'duedate' as the field name from Scheme
        duration: subscriber.scheme.duration, // Use 'duration' as the field name from Scheme
